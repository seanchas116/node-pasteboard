...
public:
    ...
    virtual void writeData(const std::string &mimeType, std::string &text);
    virtual void writeData(const std::string &mimeType, const std::vector<uint8_t> &data);
};
...
public:
    ...
    virtual std::string readDataString(const std::string &mimeType);
    virtual std::vector<uint8_t> readDataBuffer(const std::string &mimeType);
};
